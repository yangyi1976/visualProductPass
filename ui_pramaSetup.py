...
"")
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(470, 360, 381, 211))
...
"")
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(260, 590, 388, 81))
...
"")
        ...
        self.groupBox.setGeometry(QtCore.QRect(50, 360, 351, 211))
...
"text-aling:center;")
        ...
        self.horizontalLayout_4.setContentsMargins(2, 0, 0, 0)
        ...
        self.formLayout_3.setContentsMargins(2, 0, 40, 0)
...
" ")
        ...
        self.widget = QtWidgets.QWidget(winParamSetup)
        self.widget.setGeometry(QtCore.QRect(51, 241, 401, 38))
        ...
        self.lnUploadServIP = QtWidgets.QLineEdit(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.widget1 = QtWidgets.QWidget(winParamSetup)
        self.widget1.setGeometry(QtCore.QRect(480, 240, 281, 38))
        ...
        self.lnUploadServPort = QtWidgets.QLineEdit(self.widget1)
        self.lnUploadServPort.setObjectName("lnUploadServPort")
        self.horizontalLayout_6.addWidget(self.lnUploadServPort)
        self.widget2 = QtWidgets.QWidget(winParamSetup)
        self.widget2.setGeometry(QtCore.QRect(480, 120, 311, 38))
        ...
        self.lnFilesStoreDays = QtWidgets.QLineEdit(self.widget2)
        ...
        self.widget3 = QtWidgets.QWidget(winParamSetup)
        self.widget3.setGeometry(QtCore.QRect(51, 300, 701, 41))
        ...
        self.lnUploadServAPI = QtWidgets.QLineEdit(self.widget3)
    ...
    def retranslateUi(self, winParamSetup):
        ...
        self.label_8.setText(_translate("winParamSetup", "上传Server IP:"))
        self.lnUploadServIP.setInputMask(_translate("winParamSetup", "000.000.000.000"))
        self.label_10.setText(_translate("winParamSetup", "上传Server Port："))
        self.label_12.setText(_translate("winParamSetup", "废票图片存储时间："))
        self.label_13.setText(_translate("winParamSetup", "天"))
        self.label_11.setText(_translate("winParamSetup", "上传Server API:"))
